...
import { Send, Users, MessageSquare, Trophy } from 'lucide-react';
...
Respond in 2-4 sentences as this character would. Be realistic and human.`;
      ...
      // Parse the response for status markers
      ...
      if (npcResponse.includes("AGREE:|")) {
        ...
        rapportChange = 20; // Bonus rapport for getting agreement
      } 
      // Check for REFUSE
      ...
      // Update rapport (capped between -100 and 100)
  ...
  const endGame = async () => {
    ...
    try {
      // Compile all conversations for analysis
        ...
        <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-xl p-8">
          ...
          <div className="bg-indigo-50 border-l-4 border-indigo-500 p-6 mb-6">
            ...
            <div className="bg-white p-4 rounded">
              <p className="font-semibold text-indigo-800">🎯 Your Goal:</p>
              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    ...
                    {status === 'agreed' && <span className="text-2xl">✅</span>}
                    {status === 'refused' && <span className="text-2xl">❌</span>}
                  </div>
                  ...
                  <div className="mt-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs text-indigo-200">
                        {npcRapport[currentNPC] > 50 ? '😊' :
                         npcRapport[currentNPC] > 0 ? '🙂' :
                         npcRapport[currentNPC] > -50 ? '😐' :
                         '😠'}
                      </span>
                    </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className={`bg-white rounded-lg shadow-xl p-8 mb-6 border-4 ${
            ...
            <div className="text-center">
              <Trophy size={64} className={`mx-auto mb-4 ${
                goalAchieved ? 'text-green-500' : 'text-yellow-500'
              }`} />
              <h1 className="text-3xl font-bold text-gray-800 mb-2">
                {goalAchieved ? '🎉 Mission Accomplished!' : '📊 Game Complete'}
              </h1>
            ...
            {feedback.npc_feedback && Object.entries(feedback.npc_feedback).map(([npcId, npcFeedback]) => (
              <div key={npcId} className="bg-white rounded-lg shadow-lg p-6">
                <div className="flex items-center gap-3 mb-4">
                  <span className="text-3xl">{npcs[npcId]?.avatar || '👤'}</span>
                  <div className="flex-1">
                    <div className="flex items-center gap-2">
          ...
          {feedback.key_lessons && feedback.key_lessons.length > 0 && (
            <div className="bg-indigo-50 rounded-lg shadow-lg p-6 mb-6">
              <h2 className="text-xl font-bold text-indigo-900 mb-4">📚 Key Lessons</h2>
...
export default TonePersuasionGame;
